...
exports = module.exports = function (app) {
	...
	app.get('/news/post/:post', routes.views.newsPost);
	app.get('/company/:category?', routes.views.company);
	app.get('/company/post/:post', routes.views.companyPost);
	app.get('/aboutus', routes.views.aboutus);
	app.get('/person/:category?', routes.views.person);
